__title__="Casework\nHeight"
__doc__ = 'Change Height of Caseworks form Height of Walls'
__author__ = 'Phuc'
...
selection = select.select_with_cat_filter(DB.BuiltInCategory.OST_Casework, "Pick Casework form View")
...
with ProgressBar(title = 'Casework Changed: ({value} of {max_value})' ,cancellable=True) as pb:
    for i,n  in zip(selection, range(0, max_value)) :
        if pb.cancelled:
            ...
            param_e = ele.LookupParameter("Elevation") #revit 2019
