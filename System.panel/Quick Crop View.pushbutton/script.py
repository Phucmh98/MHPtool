...
from Autodesk.Revit.DB import  ViewSection ,ViewPlan, ViewCropRegionShapeManager ,CurveLoop, Line, Transaction, BoundingBoxXYZ, FilteredElementCollector, BuiltInCategory, ElementCategoryFilter, LinkElementId, UV, LocationPoint, Location, XYZ
#from Autodesk.Revit.DB.ViewCropRegionShapeManager import SetCropRegionShape
...
#Creat CropView by Drag Mousse
    ...
    #Remove non-rectangular boundary
    x = viewcrop.RemoveCropRegionShape()
    #Creat new Crop region
    p = viewcrop.SetCropShape(baseLoop)
